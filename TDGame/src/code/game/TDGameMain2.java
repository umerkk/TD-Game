...
public class TDGameMain2 implements Observer {
	...
	private void initialize() {
		...
		lblTwr1.setIcon(new ImageIcon(TDGameMain2.class.getResource("/images/tower3.png")));
		...
		lblTwr2.setIcon(new ImageIcon(TDGameMain2.class.getResource("/images/tower4.png")));
		...
		lblTwr3.setIcon(new ImageIcon(TDGameMain2.class.getResource("/images/tower.png")));
